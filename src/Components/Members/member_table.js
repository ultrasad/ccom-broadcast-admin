            ...
            return(
                !rows.length
                    ...
                    <div className="member-list">
                        ...
                        {/*
                        <div className="pagination pagination-member clearfix d-flex justify-content-between bd-highlight mb-2 mt-0">
                          <div className="mb-3"><Link style={{display: this.props.memberCurrentPage <= 1?'none':'block'}} className="prev" to={this.props.memberPrevPage} onClick={() => this.props.prevPage()}>‹ <span className="visually-hidden">Prev</span></Link></div>
                          <div className="mb-3"><span className="hiddenx info">- {this.props.memberResults} -</span></div>
                          <div className="mb-3"><Link style={{display: this.props.showNextpage !== true?'none':'block'}} className="next" to={this.props.memberNextPage} onClick={() => this.props.nextPage()}><span className="visually-hidden">Next</span> ›</Link></div>
                        </div>
                        */
                        }
                    </div>
